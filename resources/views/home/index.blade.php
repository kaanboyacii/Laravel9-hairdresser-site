			...
			<div class="row products_container">
					...
					<div class="product">
						...
						<div class="product_content clearfix">
							<div class="product_info">
								<div class="product_name"><a href="product.html">Beard shaving</a></div>
				...
				<div class="col-lg-4 product_col">
					<div class="product">
						...
						<div class="product_content clearfix">
							<div class="product_info">
								<div class="product_name"><a href="product.html">Haircut</a></div>
				...
				<div class="col-lg-4 product_col">
					<div class="product">
						...
						<div class="product_content clearfix">
							<div class="product_info">
								<div class="product_name"><a href="product.html">Hair styling</a></div>
